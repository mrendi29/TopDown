...
/**
 * Spawn Manager class which 
 * deals with the random spawn of enemies 
 * in 4 different regions based on a delay.
 * 
 * Since we need only an instance of the class
 *  the Singleton Pattern was the best choice
 * to be adapted.
 * @author caushie
 *
 */
