...
public class StartMenu {
	...
	private Image btnStart = new Image(("start.png"));
	...
	public StartMenu(int windowSizeX, int windowSizeY, String filename, String titlePic) {
		...
		this.go = new Button("", new ImageView(btnStart));
		// this.go.setStyle("-fx-font: 25 arial;");
		// this.go.setGraphic(new ImageView(new Image("start.png",100,100,true,true)));
		this.go.setLayoutX(centerX - 330);
